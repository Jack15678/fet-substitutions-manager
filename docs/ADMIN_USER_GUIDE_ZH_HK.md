...
- 人工指定代課老師，處理系統未能自動解決或全部候選均不合適的課堂；
- 管理長期缺席；
- 修改或刪除缺席及調課記錄；
- 查看統計及匯出每日代課表；
...
2. 「系統設定」：資料管理及用戶管理。
3. 「人工安排」：處理系統沒有自動方案，或所有系統候選均不合適的課堂。
4. 「顯示設定」：選擇標準／大／超大字號及系統預設／黑體／宋體／楷體；設定只保存在目前瀏覽器，不影響匯出文件。
...
1. 在「調課工作台」登記當日缺席並分析。
2. 先處理系統提供的自動調課／代課建議；如所有候選均不合適，可直接轉到人工安排。
3. 進入「人工安排」，處理未解決或決定不用系統候選的課堂。
4. 在「調課安排」核對當日有效課表。
5. 在「調課記錄」搜尋個案並檢查狀態。
6. 如需派發名單，在工作臺上方展開「匯出」，按日期下載 Excel 或 PDF。

新增缺席、核對建議、確認安排及查看記錄的基本流程與教師相同，請參閱[教師使用說明書](TEACHER_USER_GUIDE_ZH_HK.md)第四至八節。以下集中說明管理員專用功能。

## 四、人工安排未解決課堂

人工安排頁同時接受兩類尚未完成的課堂：系統分析後仍未解決的課堂，以及已有系統候選但使用者判斷全部不合適的課堂。兩者共用同一套候選資格、排序及確認流程。
...
1. 在「調課工作台」按「人工安排」，或在某堂已有候選的課堂按「系統建議均不合適，人工安排」。後者會預先選中該課堂。
...
- 「尚有 0 堂」表示目前沒有等待人工處理的未完成課堂；先返回工作台確認缺席是否已建立及分析。
...
1. 按頁面底部「編輯」（圖 5-3）。
2. 修改教師、日期、原因或節次。「其他」原因的補充文字可以留空。
...
1. 返回「調課工作台」，在頁面上方展開「匯出」。
2. 選擇匯出日期，再按「匯出 Excel」或「匯出 PDF」。
3. Excel 是單一活頁簿，每名缺席老師一個工作表；互調附註格式為 `月-日-老師全名-上班別科目`，多項以全形逗號分隔。
4. PDF 是單一檔案，A4 直向每頁上下兩表；如老師數為奇數，最後一表只放在最後一頁上半部，不再下載 ZIP。
...
普通用戶可獨立獲分配查看工作臺、新增缺席、確認建議、人工安排、查看／管理記錄、統計、每日下載、課表上傳及課表管理。開啟「新增缺席」、「確認系統建議」、「人工安排」或「每日下載」時，系統會同時開啟「查看調課工作臺」；開啟「管理調課記錄」時，亦會同時開啟「查看調課記錄」。關閉上層頁面權限會一併關閉其子權限。統計頁只受「查看統計」控制，不再因只有每日下載權限而顯示。
...
人工佇列會顯示尚未完成而且狀態為「已有系統建議」或「未解決」的課堂。先確認缺席已建立、所選節次有課，並已完成分析；已有建議的課堂亦要先在卡片按人工安排入口，才會自動帶入所選項目。
