...
1. 在「調課工作台」按「新增缺席」。
2. 選擇缺席老師和日期。
3. 選擇原因：病假、復診、帶隊訓練或其他。選擇「其他」後可填補充內容，但不要輸入病歷或其他敏感資料。
4. 勾選第 1 至第 9 節；全日缺席可勾「全天缺席」。
...
只有日期已有生效課表，而且老師、原因及至少一個節次已選擇時，「新增並分析」才可使用。只勾選老師實際有課而需要處理的節次；空堂不會建立需要安排的課堂。
...
1. 在「調課安排」選擇日期。
2. 選擇「班級課表」查看第 1 至第 9 節變動，或選擇「課堂閉環」查看完整調動路徑。
...
只有具「管理調課記錄」權限的人員會看到修改、撤銷或刪除操作。已開始的安排，或已有下游調動依賴的安排，不能直接撤銷；必須先撤銷最新而尚未開始的依賴安排。
